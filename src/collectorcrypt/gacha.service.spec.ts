...
describe('GachaService', () => {
  ...
  const row: CcPackPurchase = {
    ...
    error: null,
    // Fakta katalog CC (grade dkk) baru terisi setelah pack dibuka dan lookup ke
    // katalog CC berhasil. Baris GENERATED seperti ini memang belum punya apa pun.
    ccItemName: null,
    ccGradeCompany: null,
    ccGradeScore: null,
    ccGradeLabel: null,
